...
// Begin Class UMeocapLiveLinkSourceSettings
...
struct Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bSyncSkelToClient_MetaData[] = {
		{ "Category", "Source" },
		{ "ModuleRelativePath", "Public/MeocapLiveLinkSourceSetting.h" },
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics::NewProp_bSyncSkelToClient = { "bSyncSkelToClient", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UMeocapLiveLinkSourceSettings), &Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics::NewProp_bSyncSkelToClient_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bSyncSkelToClient_MetaData), NewProp_bSyncSkelToClient_MetaData) };
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics::PropPointers) < 2048);
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics::ClassParams = {
	...
	0,
	0x001000A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UMeocapLiveLinkSourceSettings_Statics::Class_MetaDataParams)
};
...
UMeocapLiveLinkSourceSettings::UMeocapLiveLinkSourceSettings(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
DEFINE_VTABLE_PTR_HELPER_CTOR(UMeocapLiveLinkSourceSettings);
UMeocapLiveLinkSourceSettings::~UMeocapLiveLinkSourceSettings() {}
// End Class UMeocapLiveLinkSourceSettings

// Begin Registration
struct Z_CompiledInDeferFile_FID_MeocapLiveDemo_Plugins_MeocapLiveLink_Source_MeocapLiveLink_Public_MeocapLiveLinkSourceSetting_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMeocapLiveLinkSourceSettings, UMeocapLiveLinkSourceSettings::StaticClass, TEXT("UMeocapLiveLinkSourceSettings"), &Z_Registration_Info_UClass_UMeocapLiveLinkSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeocapLiveLinkSourceSettings), 1792669692U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MeocapLiveDemo_Plugins_MeocapLiveLink_Source_MeocapLiveLink_Public_MeocapLiveLinkSourceSetting_h_2412122139(TEXT("/Script/MeocapLiveLink"),
	Z_CompiledInDeferFile_FID_MeocapLiveDemo_Plugins_MeocapLiveLink_Source_MeocapLiveLink_Public_MeocapLiveLinkSourceSetting_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MeocapLiveDemo_Plugins_MeocapLiveLink_Source_MeocapLiveLink_Public_MeocapLiveLinkSourceSetting_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
