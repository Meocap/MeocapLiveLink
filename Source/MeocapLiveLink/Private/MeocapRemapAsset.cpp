...
void UMeocapRemapAsset::BuildPoseFromAnimationData(float DeltaTime,
...
FVector UMeocapRemapAsset::ConvertRootPosition(FVector position) const
{
    return FVector(position.X, position.Z, position.Y);
}

FQuat UMeocapRemapAsset::ConvertBoneRotation(FQuat rotation) const
{
